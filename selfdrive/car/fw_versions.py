...
NISSAN_DIAGNOSTIC_REQUEST = b'\x10\xc0'
NISSAN_DIAGNOSTIC_RESPONSE = b'\x50\xc0'

NISSAN_VERSION_REQUEST = b'\x21\x83'
NISSAN_VERSION_RESPONSE = b'\x61\x83'

#NISSAN_VERSION_REQUEST = b'\x21\x84'
#NISSAN_VERSION_RESPONSE = b'\x61\x84'
...
NISSAN_RX_OFFSET1 = 0x1
NISSAN_RX_OFFSET2 = 0x3
NISSAN_RX_OFFSET3 = 0x8
NISSAN_RX_OFFSET4 = 0x20
NISSAN_RX_OFFSET5 = 0x22
NISSAN_RX_OFFSET6 = 0x3D
...
REQUESTS = [
  ...
  # RX offset 0x20 without diagnostic request
  (
    "nissan",
  ...
  (
    "nissan",
    [TESTER_PRESENT_REQUEST, DEFAULT_DIAGNOSTIC_REQUEST, EXTENDED_DIAGNOSTIC_REQUEST, NISSAN_VERSION_REQUEST_STANDARD],
    [TESTER_PRESENT_RESPONSE, DEFAULT_DIAGNOSTIC_RESPONSE, EXTENDED_DIAGNOSTIC_RESPONSE, NISSAN_VERSION_RESPONSE_STANDARD],
     NISSAN_RX_OFFSET4,
  ),
