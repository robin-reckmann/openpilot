...
FW_VERSIONS = {
  CAR.LEAF_IC: {
    ...
    (Ecu.vsp, 0x73f, None): [
      b'5SK0A\x00A\x07\x01\x00`\x00\x00\x00\x02P\x00\x00\x01\x00\x00\x00\x00\x80',
    ],
    (Ecu.esp, 0x740, None): [
      b'',
    ],
    ...
    (Ecu.bcm, 0x745, None): [
      b'5SK0AUB\x05\x17\x05( \x00\x10\x06\x82\x07\x17\x07\x88\x00\x00\x00\x80',
    ],
    (Ecu.tcu, 0x746, None): [
      b'5SA0A\x03B\x00h00003\x13U\x02\x18bb\x02\x01\x00\x80',
    ],
    (Ecu.multiAv, 0x747, None): [
      b'5SK0A\x12A\x04\x03\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x80',
    ],
    ...
    (Ecu.motorControl, 0x784, None): [
      b'5SA0A\x050\x00\x000AKAB1D2A00\x00\x00\x00\x80',
    ],
    (Ecu.charger, 0x792, None): [
      b'5SK1A G\x04\x08\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x80',
    ],
    ...
    (Ecu.hvBattery, 0x79b, None): [
      b'5SK2AVB\x05\x17\x00\x00\x00\x00\x00\x07(\x13"\x00\x00\x00\x00\x00\x80',
    ],
    ...
    (Ecu.avm, 0x7b7, None): [
      b'5SA0B\x0bA\x04\x03\x00\x11\x00\x08\x11\x11a\xa1o\x00\x92\xa0H \x80',
    ],
  },
}
